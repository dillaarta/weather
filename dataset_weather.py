...
### PURPOSE
Create table for dataset_weather from weather
...
def get_data_load():
    ...
    blobs = storage_client.list_blobs(bucket_name,prefix='weather/weather/')
    all_name = []
    for blob in blobs:
...
with DAG(
    ...
    with TaskGroup("dataset_weather") as extract_group:
        create_table = PostgresOperator(      
                task_id = "create_table_task",
                postgres_conn_id = "POSTGRES",
                sql = 'utils/sql/create_table_weather.sql',
                dag = dag
                )
