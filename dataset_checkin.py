...
### PURPOSE
Create table for dataset_checkin from yelp_academic_dataset_checkin
...
def get_data_load():
    ...
    blobs = storage_client.list_blobs(bucket_name,prefix='weather/yelp_academic_dataset_checkin/')
    all_name = []
    for blob in blobs:
...
with DAG(
    ...
    with TaskGroup("dataset_checkin") as extract_group:
        create_table = PostgresOperator(      
                ...
                sql = 'utils/sql/create_table_checkin.sql',
                dag = dag
                )
