...
### PURPOSE
Create table for dataset_user from yelp_academic_dataset_user
...
def get_data_load():
    ...
    blobs = storage_client.list_blobs(bucket_name,prefix='weather/yelp_academic_dataset_user/')
    all_name = []
    for blob in blobs:
...
with DAG(
        dag_id='yelp_academic_dataset_user',
    ...
    with TaskGroup("dataset_user") as extract_group:
        create_table = PostgresOperator(      
                task_id = "create_table_task",
                postgres_conn_id = "POSTGRES",
                sql = 'utils/sql/create_table_user.sql',
                dag = dag
                )
